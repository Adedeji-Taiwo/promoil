...
import { promoil} from "../assets/header/index";
...
const Footer = () => {
  ...
  //render based on location
   ...
   <div className="lg:container m-auto space-y-8 px-4 py-16 text-gray-600 md:px-8">
     ...
     <div className={`flex justify-center items-center border-2  h-18 w-18 rounded-lg p-1`} style={{borderColor: `${colors[value]}`}}>
          <img className='w-full h-auto max-w-[60px]' src={promoil} alt="wiizzkid logo" width="50" height="80"/>
      </div>
       <div className="flex gap-6">
       
         <a href="#" target='_blank' rel='noreferrer' aria-label="github" className="hover:text-tealLight text-gray-400">
           <svg 
         ...
         <a href="#" target='_blank' rel='noreferrer' aria-label="twitter" className="hover:text-tealLight text-gray-400">
           <svg
             xmlns="http://www.w3.org/2000/svg"
             width="20"
             height="20"
         ...
         <a href="#" target='_blank' rel='noreferrer' aria-label="facebook" className="hover:text-tealLight text-gray-400">
           <svg 
             xmlns="http://www.w3.org/2000/svg" 
             width="20"
             height="20"
     ...
     <div className="grid grid-cols-2 gap-6 sm:gap-0 md:grid-cols-3">
       <div>
         ...
         <ul className="mt-4 mb-5 md:mb-0 list-inside space-y-4 text-gray-400 text-sm">
           <li>
             <a href="#products" className={`transition hover:text-tealLight`}>Tips</a>
           </li>
           <li>
             <a href="tips" className={`transition hover:text-tealLight`}>Care</a>
           </li>
           
           <li>
             <a href="#care" className={`transition hover:text-tealLight`}>Mission</a>
           </li>
         </ul>
       </div>
       <div>
       ...
       <div>
         <h6 className="text-lg font-medium text-white cursor-pointer">Contact us</h6>
